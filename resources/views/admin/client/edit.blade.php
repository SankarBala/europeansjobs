    ...
    <div class="p-3">
        <form action="{{ route('admin.client.update', $client) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-35">
                    <select class="" name="preferred_country" disabled>
            ...
            <div class="row">
                ...
                <div class="col-25">
                    ...
                    <label class="mt-2 w-100 text-center-md" for="address">Status message</label>
                </div>
                <div class="col-35 text-right">
                    ...
                    <textarea class="mt-2" rows="5" name="statusMessage"> {{ $client->status_message }} </textarea>
